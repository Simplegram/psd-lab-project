<%@ Page Title="" Language="C#" MasterPageFile="~/Master Page/Unauthorized.Master" AutoEventWireup="true" CodeBehind="artist_detail.aspx.cs" Inherits="PSD_KpopZtation.Views.artist_detail" %>
                            ...
                            <div class="album" id="card">
				                <div class="album" id="title">
                                    ...
                                    <div style="display: flex; flex-direction: row; justify-content: space-between">
                                        ...
                                        <h3 style="margin-top: 0">Rp<%# DataBinder.Eval(Container.DataItem, "AlbumPrice", "{0, 15:N0}")%></h3>
                                    </div>
				                </div>
